module github.com/MrLittle05/Gomall/app/user

go 1.23.4

replace (
	// 模块在本地找不到，替换为本地的 rpc_gen 包
	github.com/MrLittle05/Gomall/rpc_gen => ../../rpc_gen
	github.com/apache/thrift => github.com/apache/thrift v0.13.0
)

require (
	github.com/MrLittle05/Gomall/rpc_gen v0.0.0-00010101000000-000000000000
